...
public class ControlActivity extends AppCompatActivity implements OnClickListener {
	...
	private BroadcastReceiver updatePlayTime = new BroadcastReceiver() {
		public void onReceive(Context paramContext, Intent paramIntent) {
			...
			if (paramIntent.getAction().equals(Action.PLAY_ERR_VIDEO)
				...
				Toast.makeText(tk.munditv.mtvservice.activity.ControlActivity.this, R.string.media_play_err,
	...
	protected void onDestroy() {
		tk.munditv.mtvservice.activity.ControlActivity.this.unregisterReceiver(updatePlayTime);
	...
	private void initData(Intent localIntent) {
		...
		if (null != path && null != currentContentFormatMimeType
			...
			dmcControl = new DMCControl(this, 3, dmrDeviceItem,
					this.upnpService, this.path, this.metaData, null);
