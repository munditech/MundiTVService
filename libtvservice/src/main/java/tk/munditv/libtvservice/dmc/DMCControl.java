package tk.munditv.libtvservice.dmc;
...
import tk.munditv.libtvservice.R;
import tk.munditv.libtvservice.dmc.callback.CurrentConnectionInfoCallback;
import tk.munditv.libtvservice.dmc.callback.GetCommandCallback;
import tk.munditv.libtvservice.dmc.callback.GetDeviceCapabilitiesCallback;
import tk.munditv.libtvservice.dmc.callback.GetMediaInfoCallback;
import tk.munditv.libtvservice.dmc.callback.GetMuteCallback;
import tk.munditv.libtvservice.dmc.callback.GetPackagesCallback;
import tk.munditv.libtvservice.dmc.callback.GetPositionInfoCallback;
import tk.munditv.libtvservice.dmc.callback.GetProtocolInfoCallback;
import tk.munditv.libtvservice.dmc.callback.GetTransportInfoCallback;
import tk.munditv.libtvservice.dmc.callback.GetVolumeCallback;
import tk.munditv.libtvservice.dmc.callback.PauseCallback;
import tk.munditv.libtvservice.dmc.callback.PlayerCallback;
import tk.munditv.libtvservice.dmc.callback.SeekCallback;
import tk.munditv.libtvservice.dmc.callback.SetAVTransportURIActionCallback;
import tk.munditv.libtvservice.dmc.callback.SetCommandCallback;
import tk.munditv.libtvservice.dmc.callback.SetMuteCalllback;
import tk.munditv.libtvservice.dmc.callback.SetVolumeCallback;
import tk.munditv.libtvservice.dmc.callback.StopCallback;
