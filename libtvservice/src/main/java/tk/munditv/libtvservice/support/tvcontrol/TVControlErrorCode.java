 ...
 *
 */
public enum TVControlErrorCode {
    ...
    TVControlErrorCode(int code, String description) {
        this.code = code;
    ...
    public static TVControlErrorCode getByCode(int code) {
        for (TVControlErrorCode errorCode : TVControlErrorCode.values()) {
