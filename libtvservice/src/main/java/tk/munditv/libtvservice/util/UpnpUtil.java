...
public class UpnpUtil {
    ...
    public static UDN uniqueSystemIdentifier(String salt) {
        Log.d(TAG, "uniqueSystemIdentifier()");

        StringBuilder systemSalt = new StringBuilder();
        Log.d(TAG,  "host:" + NetworkData.getHostName() + " ip:" +   NetworkData.getHostAddress());
        if (null != NetworkData.getHostName()
                && null != NetworkData.getHostAddress()) {
            systemSalt.append(NetworkData.getHostName()).append(
                    NetworkData.getHostAddress());
        }
